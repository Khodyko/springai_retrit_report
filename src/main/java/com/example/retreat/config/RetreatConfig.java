...
public class RetreatConfig {
    ...
    /**
     * Системный промпт для RAG-чата ({@code QuestionAnswerAdvisor} дополняет user-сообщение контекстом).
     */
    public static final String SYSTEM_PROMPT = """
            Ты — ассистент корпоративного ретрита.
            Отвечай на вопросы о ретрите ТОЛЬКО на основе контекста в сообщении пользователя.
            Если контекст пуст — скажи, что в базе знаний ретрита нет ответа.
            Не выдумывай расписание, спикеров и правила.
            """;

    /**
     * Системный промпт для agent-чата с tool {@code searchRetreatKnowledge}.
     */
    public static final String AGENT_SYSTEM_PROMPT = """
            Ты — ассистент корпоративного ретрита.
            Для вопросов о ретрите вызывай searchRetreatKnowledge и отвечай только по результатам tool.
            Если tool не вернул данных — скажи, что в базе знаний ретрита нет ответа.
            Не выдумывай расписание, спикеров и правила.
            """;
